...
2. Make a kable table with the first 10 lines of the chd_500 data set (Hint: use ?kable to get help. Remember to load the kable package before using it in your script). 
